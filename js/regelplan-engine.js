...
const RegelplanEngine = (() => {
  ...
  const PLANS = {
    'BII1': {
      ...
      widthM: 5,             // real-world width of the barrier zone in meters
      aspectRatio: 376/834,  // image width/height
