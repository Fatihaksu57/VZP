...
var RegelplanTemplates = (function() {
  ...
  function ensureHatchPattern(map){setTimeout(function(){var svg=map.getPanes().overlayPane.querySelector('svg');if(!svg||svg.querySelector('#vzp-workarea-hatch'))return;var defs=svg.querySelector('defs')||document.createElementNS('http://www.w3.org/2000/svg','defs');if(!defs.parentNode)svg.insertBefore(defs,svg.firstChild);var p=document.createElementNS('http://www.w3.org/2000/svg','pattern');p.setAttribute('id','vzp-workarea-hatch');p.setAttribute('patternUnits','userSpaceOnUse');p.setAttribute('width','10');p.setAttribute('height','10');p.setAttribute('patternTransform','rotate(45)');var bg=document.createElementNS('http://www.w3.org/2000/svg','rect');bg.setAttribute('width','10');bg.setAttribute('height','10');bg.setAttribute('fill','#c62828');bg.setAttribute('fill-opacity','0.05');var line=document.createElementNS('http://www.w3.org/2000/svg','line');line.setAttribute('x1','0');line.setAttribute('y1','0');line.setAttribute('x2','0');line.setAttribute('y2','10');line.setAttribute('stroke','#c62828');line.setAttribute('stroke-opacity','0.34');line.setAttribute('stroke-width','2');p.appendChild(bg);p.appendChild(line);defs.appendChild(p);},0)}
